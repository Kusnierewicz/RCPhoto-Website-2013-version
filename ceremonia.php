...
$getTotal = 'SELECT COUNT(*) FROM ceremonia';
...
$sql = "SELECT filename, caption FROM ceremonia LIMIT $startRow," . SHOWMAX;
// submit the query
...
$imageSize = getimagesize('images/ceremonia/'.$mainImage);
